...
const FeaturedVideosSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative mx-auto mt-10 h-[100vh] md:h-[130vh] lg:h-[180vh] overflow-hidden">
      ...
      <motion.div 
        style={{ y: buttonY }}
        className="w-[170px] h-[47px] md:w-[200px] md:h-[56px] rounded-2xl px-5 mx-auto z-50 relative bg-black font-extrabold mb-4 text-center cursor-pointer flex items-center justify-center gap-2"
      >
