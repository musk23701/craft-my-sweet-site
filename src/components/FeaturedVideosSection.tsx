...
const videos = [
  { id: 1, position: { top: "10vh", left: "0vw" }, zIndex: 50 },
  { id: 2, position: { top: "70vh", left: "65vw" }, zIndex: 50 },
  { id: 3, position: { top: "20vh", left: "70vw" }, zIndex: 50 },
  { id: 4, position: { top: "40vh", left: "50vw" }, zIndex: 50 },
  { id: 5, position: { top: "75vh", left: "6vw" }, zIndex: 30 },
  { id: 6, position: { top: "25vh", left: "80vw" }, zIndex: 30 },
  { id: 7, position: { top: "30vh", left: "15vw" }, zIndex: 30 },
];
...
const FeaturedVideosSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative mx-auto mt-10 h-[130vh] lg:h-[180vh] overflow-hidden">
      {/* TikTok Button */}
      <motion.div 
        style={{ y: buttonY }}
        className="w-[150px] h-[47px] md:w-[180px] md:h-[56px] rounded-2xl px-5 flex justify-center items-center mx-auto z-50 relative bg-primary font-extrabold mb-4 text-center cursor-pointer hover:bg-primary/90 transition-colors"
      >
        <a 
        ...
        <div className="relative w-full h-[150vh] overflow-hidden bg-background">
          {videos.map((video, index) => (
            <motion.div
              ...
              className="w-[170px] sm:w-[200px] md:w-[250px] lg:w-[300px] xl:w-[350px] h-[300px] sm:h-[350px] md:h-[440px] lg:h-[530px] xl:h-[620px] rounded-xl shadow-lg overflow-hidden"
              style={{
                position: "absolute",
