...
const FeaturedVideosSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative mx-auto mt-10 h-[100vh] md:h-[130vh] lg:h-[180vh] overflow-hidden">
      ...
      <motion.div 
        style={{ y: buttonY }}
        className="w-[140px] h-[44px] md:w-[180px] md:h-[56px] rounded-2xl px-4 flex justify-center items-center mx-auto z-50 relative bg-primary font-extrabold mb-4 text-center cursor-pointer hover:bg-primary/90 transition-colors"
      >
        <a 
