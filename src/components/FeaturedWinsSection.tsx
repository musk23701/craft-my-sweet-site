...
const FeaturedWinsSection = ({ title = "Featured", titleAccent = "Wins" }: FeaturedWinsProps) => {
  ...
  return (
    <section className="py-12 md:py-20 px-4 sm:px-6 bg-background">
      <div className="max-w-[1300px] mx-auto">
        ...
        >
          {title} <br className="lg:hidden" /> <span className="text-primary">{titleAccent}</span>
        </motion.h2>
...
export default FeaturedWinsSection;
