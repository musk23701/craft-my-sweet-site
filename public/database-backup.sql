...
-- =====================================================
-- DATA: PROFILES (Note: You'll need to create user in auth.users first)
-- =====================================================
-- INSERT INTO public.profiles (id, user_id, email, full_name, created_at, updated_at) VALUES
-- ('3c54b290-47e9-4a34-a02e-9488fde0ae6a', '47c069c1-b8c7-465e-be51-eb7cb0533151', 'adminlog@automindlabs.ai', NULL, '2025-12-23 06:56:21.267206+00', '2025-12-23 06:56:21.267206+00');

-- =====================================================
-- DATA: USER ROLES (Note: You'll need to create user in auth.users first)
-- =====================================================
-- INSERT INTO public.user_roles (id, user_id, role, created_at) VALUES
-- ('a1544261-eddd-4736-ab50-be1990951573', '47c069c1-b8c7-465e-be51-eb7cb0533151', 'admin', '2025-12-23 06:56:21.364664+00');

-- =====================================================
-- STORAGE BUCKET
-- =====================================================
-- Create the media storage bucket (run this in your new Supabase project)
